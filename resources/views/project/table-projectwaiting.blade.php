       ...
       @include ('includes.header')
        ...
        <div class="wrapper">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Project Waiting</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box table-responsive">
                                           ...
                                           <form class="form-horizontal" role="form" action="{{URL::to('/projectwaiting/view/')}}" method="POST">
          ...
          <div class="row">
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List Project Waiting</h4>
                            <p class="text-muted font-14 m-b-30">
                                List Project yang masih menunggu untuk dikerjakan oleh tim invistation.
                            </p>
                            ...
                            <table id="responsive-datatable" class="table table-bordered table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                      ...
                                      <?php foreach ($table as $tbl) { ?>
                                            ...
                                            <?php if ($tbl->status_project == "Not Accept"){ ?>
                                            ...
                                            <?php if ($tbl->status_project == "Accept"){ ?>

                                                <td><i class="fa fa-check-circle-o"></i><a href="{{URL::to('/projectwaiting/'.$tbl->project_id)}}">&nbsp;&nbsp;&nbsp;<?php echo $tbl->status_project; ?></a> </td>

                                            <?php } else { ?>

                                                <td><i class="fa fa-times-circle-o"></i><a href="{{URL::to('/projectwaiting/'.$tbl->project_id)}}"> &nbsp;&nbsp;&nbsp;<?php echo $tbl->status_project; ?> </a></td>
