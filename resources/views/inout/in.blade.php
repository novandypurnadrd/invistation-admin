...
<header id="topnav">
        ...
        <div class="wrapper">
                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">In Balance</li>
                                </ol>
                            </div>
                            <h4 class="page-title">In Balance</h4>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="row">
                    <div class="col-12">
                        <div class="card-box table-responsive">
                                           ...
                                           <form class="form-horizontal" role="form" action="{{URL::to('/inout/view_in/')}}" method="POST">
          ...
          <div class="row">
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List Balance In</h4>
                                ...
                                <tbody>
                                    <tr>
                                        <?php foreach ($table as $tbl) { ?>
                                            ...
                                            <td> <?php echo $tbl->produk; ?> </td>
                                            <td> <?php echo $tbl->tgl_transaksi; ?> </td>
                                            <td> <?php echo $tbl->total; ?> </td>
                                            <td> <i class="mdi mdi-credit-card-scan"></i> <a href="{{URL::to('/bukti_transfer/'.$tbl->bukti_transfer)}}" target="_blank">Bukti Transfer</a></td>
