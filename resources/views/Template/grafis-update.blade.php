    ...
    <body>
       ...
       @include ('includes.header')
        ...
        <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            <h4 class="m-t-0 header-title">Update Grafis Template</h4>
                            <p class="text-muted m-b-30 font-14">
                                Melakukan perubahan informasi template grafis undangan online.
                            </p>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="p-20">
                                        ...
                                        <form class="form-horizontal" action="{{URL::to('/grafis/edit/'.$table->id)}}" role="form" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                              ...
                                              <div class="form-group row">
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <a href="{{URL::to('/grafis_show')}}" class="btn btn-outline-dark btn-rounded waves-light waves-effectmd" role="button">Cancel</a>
                                                    &nbsp;
