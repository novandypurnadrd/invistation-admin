    ...
    <body>
       ...
       @include ('includes.header')
        ...
        <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            <h4 class="m-t-0 header-title">Update Video Template</h4>
                            <p class="text-muted m-b-30 font-14">
                                Melakukan perubahan template video undangan online.
                            </p>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="p-20">
                                        ...
                                        <form class="form-horizontal" action="{{URL::to('/video/edit/'.$table->id)}}" role="form" method="post" enctype="multipart/form-data">
