          ...
          <div class="row">
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List Template Web Invitation</h4>
                            <p class="text-muted font-14 m-b-30">
                                List Template Web yang sudah publish dan siap digunakan.
                            </p>
                            ...
                            <table id="responsive-datatable" class="table table-bordered table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($table as $tbl) { ?>
                                        ...
                                        <td><a href="{{URL::to('/preview_web/'.$tbl->preview_template)}}" target="_blank"> <?php echo $tbl->preview_template; ?></a> </td>
