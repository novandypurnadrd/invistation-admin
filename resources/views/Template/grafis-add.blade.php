    ...
    <body>
       ...
       @include ('includes.header')
        ...
        <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            <h4 class="m-t-0 header-title">Add Grafis Template</h4>
                            <p class="text-muted m-b-30 font-14">
                                Menambah template grafis undangan online.
                            </p>

                            <div class="row">
                                <div class="col-12">
                                    <div class="p-20">
                                        <form class="form-horizontal" action="{{ action('grafis@insert') }}" role="form" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-2 col-form-label">File (.zip / .rar )</label>
                                                <div class="controls col-9">
                                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                                        <button type="button" class="btn btn-custom btn-file">
                                                            <span class="fileupload-new"><i class="fa fa-paper-clip"></i> Select file</span>
                                                            <span class="fileupload-exists"><i class="fa fa-undo"></i> Change</span>
                                                            <input type="file" class="btn-light" id="filezip" name="filezip" />
                                                        </button>
