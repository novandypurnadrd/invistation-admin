                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">Grafis Invistation</li>
          ...
          <div class="row">
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List Template Grafis Invitation</h4>
                            <p class="text-muted font-14 m-b-30">
                                List Template Grafis yang sudah publish dan siap digunakan.
                            </p>
                            ...
                            <table id="responsive-datatable" class="table table-bordered table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($table as $tbl) { ?>
                                        ...
                                        <td><a href="{{URL::to($tbl->url_demo)}}" target="_blank"><?php echo $tbl->url_demo; ?> </a></td>

                                        <td><a href="{{URL::to('/preview_grafis/'.$tbl->preview_template)}}" target="_blank"> <?php echo $tbl->preview_template; ?></a> </td>
                                        
                                        <td><i class="fa fa-download"></i><a href="{{URL::to('/web/downloadfile/'.$tbl->file)}}" target="_blank"> <?php echo $tbl->file; ?></a> </td>
